...
let mayor = [0, 0, 0, 0, 0, 0, 0, 0, 0];

function info() {
    let mostrar = '<button onclick="ordenarxM();"> Ordenar por mayor precio </button> <button onclick="ordenarxm();"> Ordenar por menor precio </button> ';
    for (let x in tvs) {
